    ...
    variants: {
      variant: {
        ...
        custom: [
          ...
          "rounded-[var(--border-radius)]", // Aplicando o raio de borda personalizado
        ],
        link: [
...
export interface ButtonStyleProps {
  ...
  borderRadius: string; // Propriedade para bordas arredondadas
}
...
let Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  if (variant === "custom") {
    style = {
      ...
      "--border-radius": borderRadius, // Adicionando estilo para bordas arredondadas
...
export let buttonStylesInputs: InspectorGroup["inputs"] = [
  ...
  {
    type: "text", // Adicionando a entrada para o raio da borda
    label: "Border radius",
    name: "borderRadius",
    defaultValue: "0px",
    condition: "variant.eq.custom",
